...
class Front extends Controller
{
    ...
    public function blog_post($id) {
        return view('blog_post', array('title' => 'Welcome','description' => '','page' => 'blog', 'brands' => $this->brands, 'categories' => $this->categories, 'products' => $this->products, 'id' => $id));
    }
    ...
    public function categories_details($name){

      return view("categories_details", array('page'=> 'categories' , 'name'=>$name) );
    }
}
